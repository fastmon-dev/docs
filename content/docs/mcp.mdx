...
- **`synthetic:read`**, optional. Three tools read Lighthouse reports and need it; the other 17 work without.
...
| Errors | `get_errors`, `get_failed_resources`, `get_error_detail`, `get_failed_resource_detail` |
