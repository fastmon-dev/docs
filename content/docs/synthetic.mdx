...
Everything above is available programmatically under `/v1/sites/{site_id}/synthetic/…`: pages CRUD, on-demand runs, results, timeseries, lab-vs-field, screenshots, and the AI summaries. See the [Synthetic endpoint reference](/en/api/synthetic/listSyntheticPages).
