...
- **Filter `checkout_stage`.** Warenkorb, Checkout und Abgeschlossen sind feste Optionen in der Filterleiste, den Chips und dem Befehlsmenü. Es ist ein Filter, keine Gruppierungsdimension: Web Vitals pro Funnel-Stufe sind eine gefilterte Abfrage auf jeder Metrikseite, kein Breakdown.
...
- `checkout_stage` ist eine Filterdimension auf jedem Analytics-Endpunkt, der `filters` annimmt.
