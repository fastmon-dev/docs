...
Was er nicht liefert: eine Langzeit-Identität (er rotiert), keine Verknüpfung über Applications hinweg und nicht die harte 30-Minuten-**Besuchs**grenze. Diese Grenze und die darauf aufbauenden Per-Besuch-Metriken (Seiten pro Besuch, Bounce Rate) liefert die `session`-Identität ([`collect_sessions`](/de/tracker#collect-sessions)).
