...
Die Bündel sind ineinander geschachtelt: Ein Mitglied hat alles, was ein Viewer hat, ein Owner alles, was ein Mitglied hat. [API-Keys](/en/api/authentication) werden aus denselben Bündeln geschnitten: Die Scopes eines Keys sind Berechtigungen, und ein Key kann nie mehr als die Rolle des Users, der ihn erstellt hat.
