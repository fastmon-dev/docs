...
2. Die zugehörige Metrik-Seite lesen ([LCP](/de/web-vitals/lcp), [INP](/de/web-vitals/inp), [CLS](/de/web-vitals/cls), [FCP](/de/web-vitals/fcp), [TTFB](/de/web-vitals/ttfb)) und den Fix mit der höchsten Leverage anwenden.
...
- **Interner vs. externer Traffic verzerrt den Composite.** Office-Traffic auf warmen Caches und schnellen Laptops scort super; echte Besucher auf Mobile in einem Tunnel scoren schlechter. Internen Traffic an der Quelle ausfiltern, damit die Zahl ehrlich bleibt; siehe [Internen Traffic filtern](/de/guides/filter-internal-traffic).
