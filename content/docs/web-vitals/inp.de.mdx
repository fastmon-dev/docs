...
4. **Third-Party-Scripts.** Tag-Manager, A/B-Test-Frameworks, Chat-Widgets: viele laufen auf jedem Event. Deinen [Third-Party-Impact](/en/api/analytics/queryAnalytics) auditieren und entfernen oder deferren, was du nicht brauchst.

Tieferer Walkthrough: [Optimize INP](https://web.dev/articles/optimize-inp) auf web.dev.
