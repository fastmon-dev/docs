...
CLS ist einheitenlos, eine Summe von Layout-Shift-Scores. Tracke das **75. Perzentil**.
...
- **CLS bestraft denselben Shift auf jeder Seite.** Ein site-weiter Font-Swap oder ein dauernder Banner-Einblender heißt: jeder Pageview scort schlecht, nicht nur der erste.
