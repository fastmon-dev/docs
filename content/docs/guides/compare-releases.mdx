...
The cleanest way to catch performance regressions is to tag every deploy as a [release](/en/concepts/releases) and let the analytics API do the before/after comparison. This guide wires it up end-to-end: API token, release call from CI/CD, comparison query.
