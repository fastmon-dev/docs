...
1. **Promoted scalars** (always kept): the eight [backend phases](#backend-phases), the two [cache statuses](#cache-status), and the [page type](#page-type). These become dedicated columns.
