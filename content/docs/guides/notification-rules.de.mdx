...
**Setup-Zeit:** etwa zehn Minuten pro Rule. **Was du brauchst:** einen Owner-Account in der Organisation. Rules anlegen und ändern braucht `notification:write`, das nur Owner haben; Mitglieder und Viewer sehen die Rules und ihre Historie.
...
- Eine **Metrik** (LCP, INP, CLS, FCP, TTFB, Fehlerrate, Rate fehlgeschlagener Ressourcen, Pageviews, Visitors und die übrigen Analytics-Metriken).
