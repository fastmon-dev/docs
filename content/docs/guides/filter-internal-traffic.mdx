...
3. Either ignore the staging site in dashboards, or use it intentionally; staging metrics are useful for catching regressions before production.
...
- [Collection modes](/en/collection-modes): runtime beacon control.
