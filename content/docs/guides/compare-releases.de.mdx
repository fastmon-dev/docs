...
**Setup-Zeit:** 10–15 Minuten. **Was du brauchst:** authentifizierten fastmon-Account, Edit-Zugriff auf die CI/CD-Pipeline, eine Site, die schon [Beacons ingestet](/de/install/verify).
