...
<ChangelogEntry date="2026-07-27" type="changed" area="platform" title="Beim Anlegen einer Organisation zählt jetzt deine Website">

Beim Anlegen einer Organisation fragt fastmon jetzt nach der Domain der Website, die du messen möchtest. Du kannst eine vollständige URL einfügen (`https://www.Example.com/shop`), fastmon reduziert sie auf den Hostnamen (`example.com`). Sie ist das Hauptkriterium, an dem die Freigabe einer Organisation entschieden wird. Die Freigabe steuert weiterhin die Erfassung: Eine neue Organisation zeigt bis zur Freigabe den Hinweis „Wir prüfen deine Organisation", und eine blockierte Organisation sieht ein Banner, das die Erfassung als pausiert ausweist und die Support-Adresse nennt, damit eine Fehlentscheidung immer anfechtbar bleibt. Freigaben und Blockierungen gehen den Eigentümern der Organisation per E-Mail in ihrer Kontosprache zu.
...
<ChangelogEntry date="2026-07-26" type="changed" area="platform" title="Marketing- und Rechtsseiten sind auf fastmon.eu umgezogen">

Die App ist jetzt nur noch die App. Die Marketing-Startseite ist aus ihr verschwunden: Abgemeldete Besucher landen direkt beim Login, angemeldete beim Dashboard. Die Seiten für AGB, Datenschutz, Impressum und AVV liegen jetzt auf der Corporate-Site, und die alten In-App-Links `/terms`, `/privacy`, `/legal-notice` und `/avv` leiten dorthin weiter, damit vorhandene Lesezeichen weiter funktionieren. Die App selbst ist jetzt als `noindex` markiert.
